...
- (void)viewDidLoad
{
    ...
    UILabel *bookName = [[[UILabel alloc] initWithFrame:CGRectMake(140, 10, self.view.frame.size.width-140, 20)] autorelease];
    ...
    UILabel *autherName = [[[UILabel alloc] initWithFrame:CGRectMake(140, 30, self.view.frame.size.width-140, 20)] autorelease];
    ...
    UILabel *translator = [[[UILabel alloc] initWithFrame:CGRectMake(140, 50, self.view.frame.size.width-140, 20)] autorelease];
    ...
    UILabel *publisherName = [[[UILabel alloc] initWithFrame:CGRectMake(140, 70, self.view.frame.size.width-140, 20)] autorelease];
    ...
    UILabel *pubDate = [[[UILabel alloc] initWithFrame:CGRectMake(140, 90, self.view.frame.size.width-140, 20)] autorelease];
    ...
    UILabel *price = [[[UILabel alloc] initWithFrame:CGRectMake(140, 110, self.view.frame.size.width-140, 20)] autorelease];
    price.backgroundColor = [UIColor clearColor];
    price.text = [NSString stringWithFormat:@"定价:%@", _model.price];
    [self.view addSubview:price];
    
    UITextView *introView = [[[UITextView alloc] initWithFrame:CGRectMake(10, 170, self.view.frame.size.width-20, 200)] autorelease];
